...
class About(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        logo_image = cbtk.load_image(
            light_image=APP_IMAGES / "bear-logo-colour.jpg", image_size=(200, 200)
        )
        ...
        frm_widgets = ctk.CTkFrame(
            master=frm_main, corner_radius=widget_corner_radius, border_width=0
        )
        ...
        lbl_ctk_version = ctk.CTkLabel(
            master=frm_widgets, text=f"CustomTkinter:  {ctk.__version__}"
        )
        ...
        lbl_author = ctk.CTkLabel(master=frm_widgets, text="Logo:  Jan Bajec")
    ...
    def close_dialog(self, event=None):
        log.log_debug(
            log_text="Closing About dialogue", class_name="About", method_name="close_dialog"
        )
        self.destroy()
