...
class ProvenanceDialog(ctk.CTkToplevel):
    def __init__(self, *args, **kwargs):
        ...
        lbl_theme_label = ctk.CTkLabel(
            master=frm_header, text="Theme:", width=280, anchor="e", font=HEADING4
        )
        ...
        self.lbl_theme_name.grid(
            row=widget_row, column=2, padx=5, pady=10, sticky="w", columnspan=2
        )
        ...
        lbl_last_modified_label = ctk.CTkLabel(
            master=frm_widgets, text="Date:", width=75, anchor="e"
        )
        ...
        # Keystone Details
        widget_row += 1
        lbl_keystone_method_label = ctk.CTkLabel(
            master=frm_widgets, text="Harmony method:", width=75, anchor="e"
        )
        ...
        widget_row += 1
        lbl_keystone_colour_label = ctk.CTkLabel(
            master=frm_widgets, text="Keystone colour:", width=75, anchor="e"
        )
        ...
        self.btn_keystone_colour = ctk.CTkButton(
            master=frm_widgets, height=70, border_width=2, width=50
        )
        ...
        widget_row += 1
        lbl_created_with_label = ctk.CTkLabel(
            master=frm_widgets, font=regular_italic, text="Built with:", width=75, anchor="e"
        )
        ...
        btn_close = ctk.CTkButton(
            master=frm_buttons, text="Close", command=self.close_dialog, width=550
        )
        self.grab_set()
        self.lift()
    ...
    def close_dialog(self, event=None):
        log.log_debug(
            log_text="Close provenance dialogue",
            class_name="ProvenanceDialog",
