...
from ctk_themio.view.ctk_theme_preview import update_widget_geometry
...
class GeometryDialog(ctk.CTkToplevel):
        ...
        **kwargs,
        ...
        def slider_callback(property_name, value):
            ...
            update_widget_geometry(
                widget=geometry_widget, widget_property=config_param, property_value=property_value
            )
        ...
        self.theme_json_data["CTkFrame"]["fg_color"][cbtk.str_mode_to_int(self.appearance_mode)]
        ...
        if widget_type == "CTkFrame":
            ...
            frm_widget_preview_low = ctk.CTkFrame(
                master=frm_main,
            ...
            frm_widget_preview_low = ctk.CTkFrame(
                master=frm_main, corner_radius=5, fg_color=preview_frame_top
            )
        ...
        widget_label = ctk.CTkLabel(
            master=frm_label, text=f"{widget_type} Geometry", font=mod.HEADING5, justify=ctk.CENTER
        )
        widget_label.grid(row=0, column=0, padx=(30, 30), pady=(5, 5), sticky="ew")

        # Control buttons
        btn_close = ctk.CTkButton(
            master=frm_buttons, text="Cancel", command=self.close_geometry_dialog
        )
        ...
        if widget_type == "CTkButton":
            ...
            geometry_widget = ctk.CTkButton(
                master=frm_widget_preview_low,
            ...
            geometry_widget = ctk.CTkCheckBox(
                master=frm_widget_preview_low,
            ...
            combobox_button_hover_colour = self.theme_json_data[json_widget_type][
                "button_hover_color"
            ][mode]
            ...
            geometry_widget = ctk.CTkComboBox(
                master=frm_widget_preview_low,
            ...
            progressbar_progress_color = self.theme_json_data["CTkProgressBar"]["progress_color"][
                mode
            ]

            progressbar_border_color = self.theme_json_data["CTkProgressBar"]["border_color"][mode]
            geometry_widget = ctk.CTkProgressBar(
                master=frm_widget_preview_low,
            ...
            optionmenu_button_hover_colour = self.theme_json_data[json_widget_type][
                "button_hover_color"
            ][mode]
            ...
            geometry_widget = ctk.CTkOptionMenu(
                master=frm_widget_preview_low,
            ...
            geometry_widget = ctk.CTkRadioButton(
                master=frm_widget_preview_low,
                ...
                corner_radius=self.theme_json_data[json_widget_type]["corner_radius"],
                border_width_checked=self.theme_json_data[json_widget_type]["border_width_checked"],
            ...
            geometry_widget.bind(
                "<Button-3>",
                lambda event, widget=geometry_widget: deselect_widget(widget_id=widget),
            )
            ...
            seg_selected_hover_color = self.theme_json_data[json_widget_type][
                "selected_hover_color"
            ][mode]
            seg_unselected_color = self.theme_json_data[json_widget_type]["unselected_color"][mode]
            seg_unselected_hover_color = self.theme_json_data[json_widget_type][
                "unselected_hover_color"
            ][mode]
            seg_text_color = self.theme_json_data[json_widget_type]["text_color"][mode]
            seg_text_color_disabled = self.theme_json_data[json_widget_type]["text_color_disabled"][
                mode
            ]

            geometry_widget = ctk.CTkSegmentedButton(
                master=frm_widget_preview_low,
            ...
            geometry_widget.grid(
                row=10, column=0, padx=(15, 0), pady=(30, 0), sticky="nsew", rowspan=1
            )
            ...
            switch_button_hover_colour = self.theme_json_data[json_widget_type][
                "button_hover_color"
            ][mode]
            ...
            scrollbar_button_hover_color = self.theme_json_data[json_widget_type][
                "button_hover_color"
            ]
            ...
            geometry_widget = ctk.CTkScrollbar(
                frm_preview,
            ...
            textbox_button_color = self.theme_json_data[json_widget_type]["scrollbar_button_color"][
                mode
            ]
            textbox_button_hover_color = self.theme_json_data[json_widget_type][
                "scrollbar_button_hover_color"
            ][mode]
            textbox_text_color = self.theme_json_data[json_widget_type]["text_color"][mode]

            geometry_widget = ctk.CTkTextbox(
                frm_widget_preview_low,
                fg_color=textbox_fg_color,
                border_color=textbox_border_color,
        ...
        for property, parameters in widget_parameter.items():
            ...
            label_dict[property] = ctk.CTkLabel(
                master=frm_controls, text=base_label_text.title() + f"{current_value}"
            )
            label_dict[property].grid(row=row, column=0, sticky="ew", pady=(10, 0))
            row += 1

            slider_dict[property] = ctk.CTkSlider(
                master=frm_controls,
                from_=lower_value,
                to=upper_value,
                width=450,
                number_of_steps=(upper_value - lower_value),
                command=lambda value, label_id=property: slider_callback(label_id, value),
            )
    ...
    def save_geometry_edits(self, widget_type):
        ...
        for widget_property, property_value in self.geometry_edit_values.items():
            ...
            if self.theme_json_data[widget_type][widget_property] != property_value:
                ...
                display_property = mod.PropertyVector.display_property(
    ...
    def restore_geom_geometry(self):
        ...
        pref.preference_setting(
            db_file_path=DB_FILE_PATH, scope="window_geometry", preference_name="widget_geometry"
        )
