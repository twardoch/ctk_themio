...
from ctk_themio.view.export_import import Exporter
from ctk_themio.view.export_import import Importer
...
class ControlPanel(ctk.CTk):
    ...
    def launch_preview(self):
        ...
        if self.process is None:
            program = [sys.executable, '-m', 'ctk_themio', '-a', appearance_mode_, '-t', self.wip_json]
