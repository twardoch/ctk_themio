...
class CTkButtonDnD:
    ...
    def __init__(
        ...
        self.placement_method, self.parent_widget, self.widget_row, self.widget_column = (
            None,
            None,
            None,
            None,
    ...
    def widget_info(self):
        ...
        raise UnsupportedPlacementMethod(
            f'Widget ({self.widget}) placement method could not be confirmed as "grid" or "place".'
        )
