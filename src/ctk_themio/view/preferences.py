...
import ctk_themio.utils.loggerutl as logutl
...
class PreferencesDialog(ctk.CTkToplevel):
    def __init__(self, *args, **kwargs):
        ...
        log_level = pref.preference_setting(
            scope="logger", preference_name="log_level", default="Info"
        )

        self.log_level = log_level.upper()
        self.log_stderr = pref.preference_setting(
            scope="logger", preference_name="log_stderr", default="Yes"
        )
        ...
        frm_provenance.grid(
            column=0, row=0, padx=FRM_PADX, pady=FRM_TPADY, columnspan=2, sticky="nsew"
        )
        lbl_provenance = ctk.CTkLabel(
            master=frm_provenance, text="Provenance", justify="right", font=mod.HEADING4
        )
        ...
        self.ent_author_name = ctk.CTkEntry(
            master=frm_provenance, textvariable=self.tk_author_name, width=160
        )
        ...
        frm_appearance.grid(
            column=0, row=1, padx=FRM_PADX, pady=FRM_PADY, columnspan=1, sticky="nsew"
        )
        lbl_appearance = ctk.CTkLabel(
            master=frm_appearance, text="Appearance", justify="right", font=mod.HEADING4
        )
        ...
        self.opm_control_panel_theme = ctk.CTkOptionMenu(
            master=frm_appearance,
        ...
        rdo_light = ctk.CTkRadioButton(
            master=frm_appearance, text="Light", variable=self.tk_appearance_mode_var, value="Light"
        )
        rdo_light.grid(row=1, column=3, sticky="w")

        rdo_dark = ctk.CTkRadioButton(
            master=frm_appearance, text="Dark", variable=self.tk_appearance_mode_var, value="Dark"
        )
        ...
        lbl_control_panel_scaling = ctk.CTkLabel(
            master=frm_appearance, text="Control Panel Scaling", justify="left"
        )
        lbl_control_panel_scaling.grid(row=3, column=0, padx=(10, 5), pady=10, sticky="e")

        self.opm_control_panel_scaling = ctk.CTkOptionMenu(
            master=frm_appearance, width=12, values=mod.ui_scaling_list()
        )
        ...
        lbl_preview_panel_scaling = ctk.CTkLabel(
            master=frm_appearance, text="Preview Panel Scaling", justify="left"
        )
        lbl_preview_panel_scaling.grid(row=3, column=2, padx=(0, 5), pady=10, sticky="e")

        self.opm_preview_panel_scaling = ctk.CTkOptionMenu(
            master=frm_appearance, width=12, values=mod.ui_scaling_list()
        )
        ...
        lbl_qa_application_scaling = ctk.CTkLabel(
            master=frm_appearance, text="QA App Scaling", justify="right"
        )
        lbl_qa_application_scaling.grid(row=4, column=0, padx=(5, 5), pady=10, sticky="e")

        self.opm_qa_application_scaling = ctk.CTkOptionMenu(
            master=frm_appearance, width=12, values=mod.ui_scaling_list()
        )
        ...
        lbl_colour = ctk.CTkLabel(
            master=frm_colour, text="Colour Controls", justify="right", font=mod.HEADING4
        )
        lbl_colour.grid(row=0, column=0, padx=PADX, pady=(5, 5), sticky="w")

        lbl_shade_adjust_differential = ctk.CTkLabel(
            master=frm_colour, text="Adjust Shade Step", justify="right"
        )
        lbl_shade_adjust_differential.grid(row=1, column=0, padx=5, pady=10, sticky="e")

        self.opm_shade_adjust_differential = ctk.CTkOptionMenu(
            master=frm_colour, width=12, values=["1", "2", "3", "4", "5", "6", "7", "8", "9"]
        )
        ...
        lbl_harmony_contrast_differential = ctk.CTkLabel(
            master=frm_colour, text="Harmony Shade Step", justify="right"
        )
        lbl_harmony_contrast_differential.grid(
            row=2, column=0, padx=(10, 5), pady=(0, 0), sticky="e"
        )

        self.opm_harmony_contrast_differential = ctk.CTkOptionMenu(
            master=frm_colour, width=12, values=["1", "2", "3", "5", "6", "7", "8", "9"]
        )
        self.opm_harmony_contrast_differential.grid(
            row=2, column=1, padx=(5, 100), pady=5, sticky="w"
        )
        ...
        lbl_behaviour = ctk.CTkLabel(
            master=frm_behaviour, text="Behaviour", justify="right", font=mod.HEADING4
        )
        ...
        self.swt_enable_tooltips = ctk.CTkSwitch(
            master=frm_behaviour,
            text="Tooltips",
        ...
        self.swt_confirm_cascade = ctk.CTkSwitch(
            master=frm_behaviour,
        ...
        self.swt_enable_palette_labels = ctk.CTkSwitch(
            master=frm_behaviour,
        ...
        if self.enable_tooltips:
            CTkToolTip(
                self.swt_enable_palette_labels,
                border_width=1,
                justify="left",
                padding=(10, 10),
                corner_radius=6,
                message="Enable/disable the rendering of the colour palette labels.",
            )

        self.tk_last_theme_on_start = tk.IntVar(
            master=frm_behaviour, value=self.last_theme_on_start
        )
        self.tk_last_theme_on_start.set(self.last_theme_on_start)
        self.swt_last_theme_on_start = ctk.CTkSwitch(
            master=frm_behaviour,
        ...
        self.swt_enable_single_click_paste = ctk.CTkSwitch(
            master=frm_behaviour,
        ...
        if self.enable_tooltips:
            CTkToolTip(
                self.swt_enable_single_click_paste,
                wraplength=400,
                border_width=1,
                justify="left",
                padding=(10, 10),
        ...
        frm_comms.grid(column=1, row=2, padx=FRM_RPADX, pady=FRM_PADY, sticky="nsew")
        ...
        self.opm_listener_port = ctk.CTkOptionMenu(
            master=frm_comms, width=12, values=["5051", "5052", "5053", "5054", "5055"]
        )
        ...
        frm_themes.grid(column=0, row=3, padx=FRM_PADX, pady=FRM_BPADY, sticky="nsew")
        lbl_behaviour = ctk.CTkLabel(
            master=frm_themes, text="User Themes", justify="right", font=mod.HEADING4
        )
        lbl_behaviour.grid(row=0, column=0, padx=5, pady=(5, 5), sticky="w")

        self.folder_image = cbtk.load_image(
            light_image=APP_IMAGES / "folder.png", image_size=(20, 20)
        )
        lbl_theme_json_dir = ctk.CTkLabel(
            master=frm_themes, text="Themes Location", justify="right"
        )
        ...
        btn_theme_json_dir = ctk.CTkButton(
            master=frm_themes,
            text="",
            width=30,
            height=30,
        ...
        self.lbl_pref_theme_dir_disp = ctk.CTkLabel(
            master=frm_themes, text=self.theme_json_dir, justify="left", font=mod.REGULAR_TEXT
        )
        ...
        frm_logging.grid(column=1, row=3, padx=FRM_RPADX, pady=FRM_BPADY, sticky="nsew")
        lbl_logging = ctk.CTkLabel(
            master=frm_logging, text="Logging", justify="right", font=mod.HEADING4
        )
        ...
        self.opm_log_level = ctk.CTkOptionMenu(
            master=frm_logging, width=12, values=log.LOG_LEVEL_DISP
        )
        ...
        self.opm_log_stderr = ctk.CTkOptionMenu(master=frm_logging, width=12, values=["Yes", "No"])
        self.opm_log_stderr.grid(row=2, column=1, padx=PADX, pady=10, sticky="w")
        self.opm_log_stderr.set(str(self.log_stderr))

        lbl_log_size_label = ctk.CTkLabel(
            master=frm_logging, text="Log size (bytes):", justify="right"
        )
        ...
        self.lbl_log_size = ctk.CTkLabel(
            master=frm_logging, text=formatted_log_size, justify="right"
        )
        self.lbl_log_size.grid(row=3, column=1, padx=PADX, pady=10, sticky="w")

        btn_clear_log = ctk.CTkButton(
            master=frm_logging, text="Clear Log", command=self.clear_log, width=15
        )
        ...
        self.status_bar = cbtk.CBtkStatusBar(master=self, status_text_life=30, use_grid=True)
    ...
    def clear_log(self, event=None):
        confirm = CTkMessagebox(
            ...
            message="Are you sure you wish to erase the runtime log contents?",
            options=["Yes", "No"],
        )
        ...
        log.log_warning(
            log_text="Runtime log contents cleared.",
    ...
    def close_preferences(self, event=None):
        log.log_debug(
            log_text="Closing preferences dialogue",
            class_name="PreferencesDialog",
    ...
    def save_preferences(self):
        ...
        log.log_debug(
            log_text="Save preferences and close dialogue",
            class_name="PreferencesDialog",
        ...
        if str(self.new_theme_json_dir) != ".":
            ...
            if not mod.update_preference_value(
                ...
                print("Row miss updating preferences: user_preference > theme_json_dir")
        ...
        if not mod.update_preference_value(
            ...
            preference_value=self.user_name,
        ):
            log.log_error(log_text="Row miss updating preferences: user_preference > theme_author")
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(
                log_text="Row miss updating preferences: user_preference > control_panel_theme"
            )
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(
                log_text="Row miss updating preferences: user_preference > control_panel_mode"
            )
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(
                log_text="Row miss updating preferences: user_preference > enable_tooltips"
            )
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(
                log_text="Row miss updating preferences: user_preference > confirm_cascade"
            )
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(
                log_text="Row miss updating preferences: user_preference > last_theme_on_start"
            )
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(
                log_text="Row miss updating preferences: user_preference > enable_palette_labels"
            )
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(
                log_text="Row miss updating preferences: user_preference > enable_single_click_paste"
            )
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(
                log_text="Row miss updating preferences: user_preference > shade_adjust_differential"
            )
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(
                log_text="Row miss updating preferences: user_preference > harmony_contrast_differential"
            )
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(log_text="Row miss updating preferences: scaling > control_panel")
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(log_text="Row miss updating preferences: scaling > preview_panel")
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(log_text="Row miss updating preferences: scaling > qa_application")
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(log_text="Row miss updating preferences: user_preference > listener port")
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(log_text="Row miss updating logger > log_level")
        ...
        if not mod.update_preference_value(
            ...
            log.log_error(log_text="Row miss updating logger > log_stderr")
