"""
Written by Natt Dunn (@natdunn - Twitter)
...
if __name__ == "__main__":
    print(f'Colour colors["gray52"].hex_format() = {colors["gray52"].hex_format()}')
    print(f'Colour colors["gray28"].hex_format() = {colors["gray28"].hex_format()}')
